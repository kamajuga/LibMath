...
namespace LibMath
{
	...
	public:
		...
		static	Matrix3Dx3			createTranslation(LibMath::Vector2 const& vec);
		...
		static Matrix3Dx3			createRotationZ(LibMath::Vector2 const& center, LibMath::Radian const& angle); // In 2D the rotation is done by the Z axis
